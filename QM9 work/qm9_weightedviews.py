...
def qm9bfiletowvmats(alist,speciesmap,carbonbased=False,splitx=True,viewlength=None):
...
def load_qm9_data(all_molecules,setNatoms=None,setNviews=None,carbonbased=False,splitx=True,chemnames=None,verbose=0):
    ...
    varrays = []
    for mol in all_molecules:
        w, v = qm9bfiletowvmats(mol, speciesmap, carbonbased=carbonbased, splitx=splitx, viewlength=Natoms)
        warrays.append(w)
        varrays.append(v)
